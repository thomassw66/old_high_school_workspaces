 ...
 * Followed instructions to the letter can't get right output
 * JUST GOING TO LEAVE THIS PROBLEM ALONE FOR NOW
 */
...
public class MapMaker {
	...
	public static void main(String[] args) {
		...
		ArrayReference a = defined.get("THREE");
		System.out.println(a.name);
		System.out.println(a.C0);
		System.out.println(Arrays.toString(a.C)); 
		System.out.println(Arrays.toString(a.lowerBounds)); 
		System.out.println(Arrays.toString(a.upperBounds)); 
		int [] d = {7};
		System.out.println(a.calcAddr(d));
	}
